# Implementing Text-to-SQL RAG with Amazon Bedrock Knowledge Bases and OpenSearch Serverless
...
```json
{
  "metadataAttributes": {
    ...
    "canonical_ref": "registry:finance.revenue@7",
    "source_hash": "d61fe0fa6f927d0f566ea7225b77383652ac5699c87d6a05b763ba4ce1dd4815",
    "language": "en",
    "is_synthetic": true
  }
}
...
```json
{
  ...
  "retrievalQuery": {
    "text": "Revenue by current customer region for January 2026"
  },
      ...
      "filter": {
        "andAll": [
          ...
          },
          {
            "equals": {
              "key": "access_scope",
              "value": "finance-analysts-demo"
            }
          },
          {
            "equals": {
              "key": "snapshot_id",
              "value": "catalog-demo-42"
            }
          },
          {
            "equals": {
...
```json
{
  "rerankingConfiguration": {
    ...
    "bedrockRerankingConfiguration": {
      "modelConfiguration": {
        "modelArn": "YOUR_SUPPORTED_RERANKER_MODEL_ARN"
      },
